...
One day I was in need of decrypting some tokens and couldn't find any information on the subject so I spent some time studying the format of the cookie and wrote some code to decrypt them. You can check out the code from "here":http://github.com/offbytwo/samples/tree/master/LTPAUtils/
